					...
					<div class="d-inline-block align-items-center">
						<nav>
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item" aria-current="page">Email Investors</li>
		 ...
		 <!-- Basic Forms -->
		  <div class="box">
			<div class="box-header with-border">
			  <h4 class="box-title">Send mail to all Investors</h4>
					  ...
					  <div class="row">
						<div class="col-12">						
							<div class="form-group">
								...
								<div class="form-control-feedback"><small>This field is <code>required</code></small></div>
							</div>
						<br>
							<div class="form-group">
