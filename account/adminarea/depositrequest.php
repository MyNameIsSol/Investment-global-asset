					...
					<div class="d-inline-block align-items-center">
						<nav>
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item" aria-current="page">Approve user Deposit</li>
				...
				<div class="col-12">
					<div class="box">
						<div class="box-header with-border">
						  <h4 class="box-title">Deposit request</h4>
						</div>
						<div class="box-body">
								...
								<table class="table table-bordered dataTable no-footer table-striped" id="dataTable_crypto">
								  <thead>
									 <tr>
										...
										<th class="text-end">DATE OF DEPOSIT</th>
								  ...
								  <?php
									...
									<tr>
									   ...
									   <td class="text-end"><p><a href="https://www.securedglobalasset.com/account/clientarea/payment/'.$proof.'"><img src="https://www.securedglobalasset.com/account/clientarea/payment/'.$proof.'" alt="view payment proof"></a></p></td>
									   <td class="text-end"><p><span>$</span>'.$walletbal.'</p></td>
									   <td class="no-wrap text-end"> '.$dateofdep.'</td>
									   <td class="no-wrap text-end"> '.$statusofdep.'</td>
									   <td class="no-wrap text-end"> '.$depositid.'</td>';
									   if($statusofdep == "Approved"){
										 echo '<td>Deposit has been Approved</td>';
									   }else{
										 echo'<td>
											  <form method="POST" action="../configs/approveuserdeposit.php">
												  <input type="hidden" name="depositid" value="'.$depositid.'">
												  <input class="btn btn-success" type="submit" name="approvedep" value="APPROVE">
											  </form>
										  </td>';
									   }
									   echo'<td>
									   <form method="POST" action="../configs/deleteuserdeposit.php">
										  <input type="hidden" name="depositid" value="'.$depositid.'">
