					...
					<div class="d-inline-block align-items-center">
						<nav>
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item" aria-current="page">View and Send Endsars Support Applicant a Message</li>
...
<div class="box">
    <div class="box-header with-border">
        <h4 class="box-title">Endsars Support Applicant</h4>
    </div>
    <div class="box-body">
        <div class="table-responsive">
            <table class="table table-bordered dataTable no-footer table-striped" id="dataTable_crypto">
                <thead>
                    ...
                    <th class="text-end">NAME OF DECEASED</th>
                    <th class="text-end">GENDER OF DECEASED</th>
                    <th class="text-end">RELATIONSHIP TO DEASED</th>
                ...
                <tbody>
                <?php
                $sql = "SELECT * FROM endsars ORDER BY id DESC";
                ...
                $no_deceased= $data['no_deceased'];
                $geno_deceased= $data['geno_deceased'];
                $rto_deceased= $data['rto_deceased'];
                $regdate= $data['reg_date'];
                echo'
                <tr>
                    <td class=" text-end pt-0 pb-0"><img src="../clientarea/endsars/'.$image.'" width="50" height="50"></td>
                    ...
                    <td class="no-wrap text-end"> '.$no_deceased.'</td>
                    <td class="no-wrap text-end"> '.$geno_deceased.'</td>
                    <td class="text-end"><p><span></span>'.$rto_deceased.'</p></td>
                    <td class="no-wrap text-end"> '.$regdate.'</td>';
     
                    echo'<td>
                        <form method="POST" action="sendsarsmail.php">
                            <input type="hidden" name="email" value="'.$email.'">
                            <input class="btn btn-success" type="submit" name="sendsarsmail" value="Reply">
                        </form>
                    </td>';
                    echo'<td>
                    <form method="POST" action="../configs/deletesars.php">
                        <input type="hidden" name="email" value="'.$email.'">
