            ...
            <div class="col-12 mb-3 mt-4" style="background-image:linear-gradient(to right, #ff8838 0%, #ffa938 100%); padding:15px 10px; border-radius:4px;">
                        <div class="balholder align-items-center">
                            <div class="widget__left ml-3">
                                <p class=" mb-1" style="font-weight:600; color:#fff; font-size:18px">Your Withdrawals</p>
                            </div>
                        </div>
                        </div>
                    ...
                    <div class="widget-content widget-content-area br-6">
                        <table id="zero-config" class="table dt-table-hover" style="width:100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th style='font-family: Georgia, serif;'>WITHDRAWAL ID</th>
                                        <th style='font-family: Georgia, serif;'>DATE OF WITHDRAWAL</th>
                                        <th style='font-family: Georgia, serif;'>AMOUNT</th>
                                        <th style='font-family: Georgia, serif;'>WITHDRAWAL STATUS</th>
                        ...
                        $result_check = mysqli_num_rows($result);
                                ...
                                echo ' <tr>
                                        ...
                                        <td><span class="inv-number text-warning">'.$withdrawalid.'</span></td>
                                        <td><span class="inv-date"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-calendar"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg>'.$dateofwith.'</span></td>
                                        <td><span class="inv-amount">$'.$amount.'</span></td>';
                                        if($statusofwith == "Pending"){
                                            echo '<td><span class="badge outline-badge-info inv-status">'.$statusofwith.'</span></td>';
                                            }elseif($statusofwith == "PAID"){
                                            echo '<td><span class="badge outline-badge-success inv-status">'.$statusofwith.'</span></td>';	
                                            }else{
