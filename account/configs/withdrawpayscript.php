				...
				<table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
				  ...
				  <tr>
					<td bgcolor="#ffffff" align="left" style="padding: 10px 10px 20px 10px; color: #666666; font-family: "Poppins", sans-serif; font-size: 16px; font-weight: 400; line-height: 25px;">
							  <p style="margin:10px 13px; font-size: 12px;">Your Withdrawal of $'.$amount.' has been sent.</p>
							  <p style="margin:10px 13px; font-size: 12px;">The payment is currently being processed...</p>
							  <p style="margin:10px 13px; font-size: 12px;">Please, check your cryptocurrency wallet with the address '.$btcaddr.'</p>
					</td>
				  </tr>
